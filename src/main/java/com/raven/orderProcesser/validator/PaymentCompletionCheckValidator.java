...
@Component
public class PaymentCompletionCheckValidator implements Validator {

	@Autowired
	ValidationService validationService;

	@Value("${validator.payment-completion-check}")
	private String serviceName;

	@Override
	public CompletableFuture<ValidationResponse> fetchValidationDetails(Order order) {
		return validationService.paymentCompletionCheck(order, serviceName);
	}
